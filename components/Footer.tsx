...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#050505] text-zinc-500 py-16 px-6 border-t border-zinc-900">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-center items-center gap-10">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="flex items-center space-x-3 text-white">
            <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center font-bold shadow-lg shadow-blue-900/20">
              <i className="fa-brands fa-google-drive text-lg"></i>
            </div>
            <div className="flex flex-col text-left">
              <span className="font-black text-xl tracking-tight leading-none text-white">Drive do Concurseiro</span>
      ...
      <div className="max-w-6xl mx-auto mt-16 pt-8 border-t border-zinc-900 text-center text-[10px] font-medium tracking-tighter uppercase text-zinc-700">
